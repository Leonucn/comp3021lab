...
public class Heap<T extends Comparable<T>> {
    ...
    private void heapifyUp() {
        ...
        // Check parent existence 					Check smaller or not
            swap(pos, getParentIndex(pos)); // swap the two elements

        	pos = getParentIndex(pos); // Check again with the new parent until any one condition become wrong
        }
    }
